...
```{r}
par(mfrow=c(1,3))
plot(AsstProfessors$salary~AsstProfessors$sex, main="Salary and Sex (Asst Prof)", col.main="#EAAA00",col="#002855")
plot(AssocProfessors$salary~AssocProfessors$sex, main="Salary and Sex (Assoc Prof)", col.main="#002855",col="#EAAA00")
plot(Professors$salary~Professors$sex, main="Salary and Sex (ALL)", col.main="#EAAA00",col="#002855")
```
