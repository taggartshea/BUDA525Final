...
```{r}
par(mfrow=c(1,3))
plot(AsstProfessors$salary~AsstProfessors$sex)
plot(AssocProfessors$salary~AssocProfessors$sex)
plot(Professors$salary~Professors$sex)
```
