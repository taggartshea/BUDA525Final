...
Checking if there is a promotion discrepancy by creating models for predicting the number of years someone has been there to what rank they are, by sex
```{r}
#for Males
